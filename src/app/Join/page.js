      ...
      <div className="flex flex-col items-center justify-center lg:flex-row">
        <div className="mx-[3vw] relative">
          ...
          <p className="text-center text-xl">
            ...
            <button
              onClick={switchView}
              className="text-buttonColor font-extrabold underline pl-[1vw]"
            >
              {isLoginView ? "Signup now" : "Login now"}
            </button>
          </p>
        </div>
        <div>
          <Image
            src={
              isLoginView ? "/Images/login-boy.png" : "/Images/signup-boy.png"
            }
            alt="auth-side-image"
            width={300}
            height={200}
